...
<ol>
	...
	<li>Database host</li>
	<li>Table prefix (if you want to run more than one ReOS in a single database) </li>
</ol>
...
configuration file. You may also simply open <code>config-sample.php</code> in a text editor, fill in your information and save it as <code>config.php</code>.</strong></p>
...
<p class="step"><a href="setup-config-3.php" class="button">Let’s go!</a></p>
</body></html>